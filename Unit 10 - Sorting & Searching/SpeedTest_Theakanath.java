...
interface IntFinder
{
	int find( int[] haystack, String needle );
}
...
{
	public int find(int[]haystack, String needle)
	{
...
/** 
	...
	number accordingly.
*/
public class SpeedTest_Theakanath
{
	...
	public static void main(String[]args)
	{
		...
		{
			IntFinder teachers = new BinaryFinder();
			...
			IntFinder teachers = new SequentialFinder();
			System.out.println("Enter the name of the teacher you want to find.");
			String name = scan.nextLine();
			System.out.println("Finding name....");
			int result = teachers.find(getList(), name);
